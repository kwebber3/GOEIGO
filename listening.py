...
class Listening(Toplevel,):
    def __init__(self):
        ...
        self.show_button = tkinter.Button(self, text="例文を見せる", command=lambda:self.ShowExample())
        self.show_button.grid(row=0, column=0)

        self.show_button = tkinter.Button(self, text="答えを見せる", command=lambda:self.ShowAnswer())
