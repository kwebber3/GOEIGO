...
class HomePage:
    def __init__(self):
        ...
        tkinter.Button(navBar, text="言葉認識", command=Listening,justify=LEFT).grid(row=0,column=0, columnspan=1)
        tkinter.Button(navBar, text="言葉思い出し",command=Speaking,justify=LEFT).grid(row=0,column=1)
